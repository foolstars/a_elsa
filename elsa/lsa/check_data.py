...
def main():
  ...
  dataFile.seek(0)
  try:
    np.genfromtxt( dataFile, comments='#', delimiter='\t', missing_values=['na','','NA'], filling_values=np.nan, usecols=range(1,spotNum*repNum+1) )
  except ValueError:
    print("Numpy can't read", str(ValueError))
